## Contributing to FOVA.js

♥ [FOVA.js](https://github.com/sunel/fova.js) and want to get involved? Thanks!
...
The [issue tracker](https://github.com/sunel/fova.js/issues) is the preferred channel
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure
   ...
   git clone https://github.com/<your-username>/fova.js.git
   # Navigate to the newly cloned directory
   cd fova.js
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/sunel/fova.js
   ```
